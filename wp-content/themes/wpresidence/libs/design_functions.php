...
if(!function_exists('wpestate_custom_fonts_elements')):
    function wpestate_custom_fonts_elements(){
        ...
        if ($p_fontsize != '') {
            $style.=  '.overview_element:first-of-type li, .overview_element, .single-content,p,.single-estate_property .listing_detail .price_label{font-size:' . $p_fontsize .';}';
        }
        if ($p_lineheight != '') {
        ...
        if ($menu_fontweight != '') {
            $style.= '.submit_listing,.header_phone,#access a,#user_menu_u{font-weight:' . $menu_fontweight .';}';
        }
