...
if (!function_exists('wpestate_check_gdpr_case')):
    ...
    function wpestate_check_gdpr_case($extra = '') {
        ...
        if (wpresidence_get_option('wp_estate_use_gdpr', '') == 'yes') {
            ...
            print'<div class="gpr_wrapper"><input type="checkbox" role="checkbox" aria-checked="false" id="wpestate_agree_gdpr' . $extra . '" class="wpestate_agree_gdpr" name="wpestate_agree_gdpr" />
