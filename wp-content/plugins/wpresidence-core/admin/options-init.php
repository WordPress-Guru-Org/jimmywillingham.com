        ...
        'fields'     => array(
            ...
            array(
             ...
             array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Login is mandatory to save favorites? ', 'wpresidence-core' ),
                'subtitle' => __( 'Require login to save and view favorites', 'wpresidence-core' ),
                'options'  => array(
                    'no'  => 'no',
                    'yes' => 'yes'
                    ),
    ...
    'fields'     => array(
           ...
           array(
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Property List Order in Taxonomies page', 'wpresidence-core' ),
                'subtitle' => __( 'Property List Order in Taxonomies page', 'wpresidence-core' ),
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Property List Order in Advanced Search page', 'wpresidence-core' ),
                'subtitle' => __( 'Property List Order in Advanced Search page', 'wpresidence-core' ),
                'options'  => $listing_filter_array,
                'default'  => "0",
            ),
        ...
        'fields'     => array(
            ...
            array(
             ...
             array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Print Logo', 'wpresidence-core' ),
                'subtitle' => __( 'Upload mobile logo in jpg or png format.', 'wpresidence-core' ),
            ),
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => __( 'Select header alignment.Please note that there is no "center" align for type 3,4 and 6.', 'wpresidence-core' ),
                'options'  => array(
                    'left'   => 'left',
                    'center' => 'center',
                    'right'  => 'right'
            ...
            array(
                ...
                'subtitle' => __( 'Select a text alignment for header 3,4 and 6.', 'wpresidence-core' ),
                'options'  => array(
                    'left'   => 'left',
                    'center' => 'center',
                    'right'  => 'right'
            ...
            array(
                ...
                'type'     => 'button_set',
                'title'    => __( 'Media Header Type for Blog Post?', 'wpresidence-core' ),
                'subtitle' => __( 'Select what media header to use globally for blog posts.', 'wpresidence-core' ),
                'options'  => array(
                    'none',
                    'image',
                    'theme slider',
            ...
            array(
                ...
                'subtitle' => __( 'Select taxonomies for similar listings( if none is selected we will use property category, property action category and property city)', 'wpresidence-core' ),
                 ...
                 'options'  => array(
                        ...
                        'property_action_category'=>'action cateogory',
                        'property_city'=>'city',
                    ),
