...
class Plugin {
    ...
    public function register_widgets() {
        ...
        // Register Widgets
                \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Blog_Post_List());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Search_Form_Builder());
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Sliding_Box());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Properties_Slider_v2());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Testimonial_Slider());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Video_Player()); 
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_HotSpots());    
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Agent_Grids());  
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Widgets\Wpresidence_Favorite_List());  
