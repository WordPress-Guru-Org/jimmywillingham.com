...
class ReduxFramework_Extension_wpestate_custom_unit_design_extended extends Redux_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['wpestate_custom_unit_design'];
