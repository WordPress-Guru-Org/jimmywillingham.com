...
class ReduxFramework_Extension_wpestate_taxonomy_tabs_price_extended extends Redux_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['wpestate_taxonomy_tabs_price'];
